            ...
            <form action="{{ route('students.update', $student->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="enrollment" id="enrollment" class="form-control"
                        value="{{ old('enrollment', $student->enrollment) }}" placeholder="Ejemplo: ZFMJIS3225">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="name" id="name" class="form-control"
                        value="{{ old('name', $student->name) }}" placeholder="Ejemplo: Juan">
                    @if ($errors->has('name'))
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="paternal_surname" id="paternal_surname" class="form-control"
                        value="{{ old('paternal_surname', $student->paternal_surname) }}" placeholder="Ejemplo: López">
                ...
                <div class="mb-3">
                    ...
                    <input type="email" name="email" id="email" class="form-control"
                        value="{{ old('email', $student->email) }}" placeholder="Ejemplo:jessm@email.com">
                    @if ($errors->has('email'))
                ...
                <div class="mb-3">
                    ...
                    <input type="phone" name="phone" id="phone" class="form-control"
                        value="{{ old('phone', $student->phone) }}" placeholder="Ejemplo:255-1234-5678">
                    @if ($errors->has('phone'))
